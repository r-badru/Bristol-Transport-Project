...
{w:"Henbury & Brentry",pop:13488,tdi:54.1,tp:2.07,te:60,td:0,sd:5.19,inc:46300,nc:22.5,gh:82.4,ls:65.3,mw:20.4,sa:53.2,fi:5.7,fc:18.7,lp:14.1,qu:12.8,ag:50,pr:"Moderate Need",cl:"#F59E0B",cw:9.9,cwk:4.8,dw:52.1,bw:15.2,wcw:14.2,pl:11.1,cs:12.3,nt:45.8,bs:42.6,ln:4.8,st:73.8,ia:11.6,dp:"Medium-High",ds:4,ab:"Medium",an:"frequency and affordability",p65:2169,fsm:32.6,sen:20.2,dis:34.8},
{w:"St George West",pop:7003,tdi:53.2,tp:2.19,te:60,td:0,sd:5.71,inc:43900,nc:27.4,gh:84.3,ls:59.4,mw:25.3,sa:49.1,fi:4.9,fc:20.8,lp:13.4,qu:11.5,ag:42,pr:"Stable",cl:"#10B981",cw:30.3,cwk:27,dw:27.4,bw:10.7,wcw:52.3,pl:11.8,cs:8.7,nt:42.7,bs:47,ln:5.3,st:78.6,ia:8.9,dp:"Medium-High",ds:4,ab:"Medium",an:"none noted",p65:798,fsm:22.6,sen:19.8,dis:23.6},
{w:"Central",pop:21128,tdi:52.9,tp:2.22,te:86.7,td:0,sd:4.73,inc:43300,nc:57.3,gh:75.9,ls:56.5,mw:31.2,sa:57.4,fi:7,fc:21.7,lp:9.4,qu:7.7,ag:28,pr:"Latent Demand",cl:"#3B82F6",cw:23,cwk:9.6,dw:14.8,bw:10,wcw:57.3,pl:25.8,cs:20.9,nt:38,bs:33.5,ln:8.1,st:66.3,ia:5.5,dp:"High",ds:5,ab:"Medium",an:"cost and overcrowding; highest no-car rate",p65:409,fsm:37,sen:21.2,dis:35.9},
{w:"Windmill Hill",pop:13861,tdi:50.7,tp:1.83,te:66.7,td:0,sd:6.49,inc:52550,nc:25.5,gh:87.3,ls:71.2,mw:19.1,sa:66,fi:5.4,fc:13.9,lp:12.8,qu:11.1,ag:44,pr:"Stable",cl:"#10B981",cw:31.4,cwk:17.2,dw:23,bw:13,wcw:44.6,pl:19.7,cs:7.2,nt:46.1,bs:31.8,ln:3.9,st:78.9,ia:4.6,dp:"Medium-High",ds:4,ab:"Medium",an:"unreliable services, poor connections",p65:1177,fsm:20.1,sen:16,dis:20.8},
{w:"Brislington West",pop:11980,tdi:47.5,tp:1.9,te:46.7,td:0,sd:2.5,inc:50450,nc:20.2,gh:80.7,ls:65.1,mw:15.8,sa:64.5,fi:3.8,fc:11.8,lp:12.2,qu:9.8,ag:38,pr:"Stable",cl:"#10B981",cw:28.5,cwk:18.4,dw:37.2,bw:20.8,wcw:27.6,pl:31.1,cs:17.4,nt:52.8,bs:40.8,ln:4.5,st:75.7,ia:7.3,dp:"Medium-High",ds:4,ab:"Low",an:"none noted",p65:1655,fsm:22.1,sen:17.9,dis:22.8},
{w:"Horfield",pop:14013,tdi:46.3,tp:2.05,te:53.3,td:0,sd:6.42,inc:46850,nc:22.6,gh:83.8,ls:64.5,mw:17.4,sa:65.1,fi:7.3,fc:17.7,lp:13.8,qu:10.1,ag:40,pr:"Stable",cl:"#10B981",cw:32.1,cwk:20.8,dw:40.5,bw:10.4,wcw:39.6,pl:21.6,cs:11.5,nt:48,bs:47.7,ln:4.9,st:71.5,ia:7.7,dp:"Medium",ds:3,ab:"Medium",an:"none noted",p65:1669,fsm:24.7,sen:15.8,dis:25.3},
{w:"Southville",pop:12896,tdi:45.1,tp:1.71,te:53.3,td:0,sd:7.75,inc:56100,nc:30.2,gh:83.5,ls:70,mw:14.6,sa:67.2,fi:4.9,fc:15.3,lp:10.1,qu:8.8,ag:34,pr:"Stable",cl:"#10B981",cw:32.5,cwk:20.2,dw:28.3,bw:9,wcw:55.6,pl:28.3,cs:13.8,nt:39,bs:36.9,ln:3.2,st:61.4,ia:3.5,dp:"Medium",ds:3,ab:"Low",an:"none noted",p65:1118,fsm:13,sen:14.7,dis:13.3},
{w:"Lockleaze",pop:13626,tdi:44.8,tp:2.18,te:60,td:0,sd:4.4,inc:44000,nc:24.3,gh:81.5,ls:59,mw:16.8,sa:58.5,fi:7.5,fc:19.4,lp:14.5,qu:13,ag:50,pr:"Moderate Need",cl:"#F59E0B",cw:29.8,cwk:24.6,dw:30.3,bw:16.7,wcw:37.6,pl:24.4,cs:14.9,nt:50.6,bs:35.9,ln:4.3,st:67.2,ia:11.5,dp:"Medium-High",ds:4,ab:"Medium",an:"affordability and frequency",p65:1587,fsm:32.4,sen:20.7,dis:32.9},
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 mb-5 border-l-4 border-blue-600">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <span className="bg-purple-50 text-purple-700 px-2.5 py-1 rounded-full font-medium">R2 up to 0.82</span>
